...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OutgoingMessage.meta'
        db.add_column('app_outgoingmessage', 'meta', self.gf('app.db.fields.BlobField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OutgoingMessage.meta'
        db.delete_column('app_outgoingmessage', 'meta')
