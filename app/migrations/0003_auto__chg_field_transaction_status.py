...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_transaction', 'status', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Transaction.status'
        db.alter_column('app_transaction', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))
