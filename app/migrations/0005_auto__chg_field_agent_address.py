...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agent.address'
        db.alter_column('app_agent', 'address', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Agent.address'
        db.alter_column('app_agent', 'address', self.gf('django.db.models.fields.CharField')(max_length=50))
