...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('app_user', ['phone'])

        # Changing field 'User.first_name'
        db.alter_column('app_user', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'User.last_name'
        db.alter_column('app_user', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'User.address'
        db.alter_column('app_user', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=30))


    def backwards(self, orm):
        
        # Changing field 'User.first_name'
        db.alter_column('app_user', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'User.last_name'
        db.alter_column('app_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Adding unique constraint on 'User', fields ['phone']
        db.create_unique('app_user', ['phone'])

        # Changing field 'User.address'
        db.alter_column('app_user', 'address', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
