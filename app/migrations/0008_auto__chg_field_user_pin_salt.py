...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.pin_salt'
        db.alter_column('app_user', 'pin_salt', self.gf('django.db.models.fields.CharField')(max_length=70))


    def backwards(self, orm):
        
        # Changing field 'User.pin_salt'
        db.alter_column('app_user', 'pin_salt', self.gf('django.db.models.fields.CharField')(max_length=10))
