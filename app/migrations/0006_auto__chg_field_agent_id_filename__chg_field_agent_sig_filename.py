...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_agent', 'id_filename', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'Agent.sig_filename'
        db.alter_column('app_agent', 'sig_filename', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))


    def backwards(self, orm):
        
        # Changing field 'Agent.id_filename'
        db.alter_column('app_agent', 'id_filename', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Agent.sig_filename'
        db.alter_column('app_agent', 'sig_filename', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
